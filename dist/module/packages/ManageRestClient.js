...
export class ManageRestClient extends AbstractRestClient {
  ...
  getTokenDetails(endpoint = ":version/auth/token") {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        const result = yield this.get(requestUrl).then((result) =>
          result.json()
        );
  ...
  updateProject(projectId, options, endpoint = ":version/projects/:projectId") {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        const result = yield this.patch(requestUrl, body).then((result) =>
          result.json()
        );
        return { result, error: null };
      } catch (error) {
  ...
  updateProjectMemberScope(
    ...
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        const body = JSON.stringify(options);
        const result = yield this.put(requestUrl, body).then((result) =>
          result.json()
        );
        return { result, error: null };
      } catch (error) {
  ...
  leaveProject(projectId, endpoint = ":version/projects/:projectId/leave") {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        const requestUrl = this.getRequestUrl(endpoint, { projectId });
        const result = yield this.delete(requestUrl).then((result) =>
          result.json()
        );
        return { result, error: null };
      } catch (error) {
